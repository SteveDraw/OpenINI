...
namespace OpenINI
{
    public partial class ConfigUI : UIForm
    {
        public OpenINI opi;
        ...
        /// <param name="e"></param>
        private void btnFreshConifg_Click(object sender, EventArgs e)
        {
            Select();
            ClearText();
            if (cbxSection.Items.Count == 0)
            MessageBox.Show("配置内容为空，无列表内容", "更新提示", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        private void btnSelectFile_Click(object sender, EventArgs e)
        {
            ...
            opn.InitialDirectory =Application.StartupPath+"\\ini";
            opn.Title = "选择配置文件";
